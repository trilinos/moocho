...
typedef SparseLinAlgPack::DVectorSlice (SparseLinAlgPack::DMatrixSlice::*Pvec_func)
	(SparseLinAlgPack::DMatrixSlice::size_type);
// Implement sparse matrix, dense matrix assignment.  Sizes are not checked.
template<class T_Matrix>
void imp_assign(SparseLinAlgPack::DMatrixSlice& gms_lhs, const T_Matrix& gm_rhs
	, BLAS_Cpp::Transp trans_rhs)
{
	// If trans, then copy col into row, otherwise copy col into col.
	Pvec_func vec_func;
	if(trans_rhs == BLAS_Cpp::no_trans)		vec_func = &SparseLinAlgPack::DMatrixSlice::col;
	else									vec_func = &SparseLinAlgPack::DMatrixSlice::row;
...
template<class T_Matrix>
void SparseLinAlgPack::assign(DMatrix& gm_lhs, const T_Matrix& gm_rhs
	, BLAS_Cpp::Transp trans_rhs)
{
...
template<class T_Matrix>
void SparseLinAlgPack::assign(DMatrixSlice& gms_lhs, const T_Matrix& gm_rhs
	, BLAS_Cpp::Transp trans_rhs)
{
...
void imp_assert_V_MtV_rhs_sizes(const T_Matrix& gm_rhs1, BLAS_Cpp::Transp trans_rhs1
	, const SparseLinAlgPack::DVectorSlice& vs_rhs2)
{
...
template<class T_Matrix>
void imp_V_MtV_no_trans(SparseLinAlgPack::DVectorSlice& vs_lhs, const T_Matrix& gm_rhs1
	, const SparseLinAlgPack::DVectorSlice& vs_rhs2)
{
	typedef typename T_Matrix::size_type size_type;
	size_type rows = gm_rhs1.rows();
	SparseLinAlgPack::DVectorSlice::iterator itr_v_lhs = vs_lhs.begin();
...
template<class T_Matrix>
void imp_V_MtV_trans(SparseLinAlgPack::DVectorSlice& vs_lhs, const T_Matrix& gm_rhs1
	, const SparseLinAlgPack::DVectorSlice& vs_rhs2)
{
	typedef typename T_Matrix::size_type size_type;
...
template<class T_Matrix>
void SparseLinAlgPack::V_MtV(DVector& v_lhs, const T_Matrix& gm_rhs1, BLAS_Cpp::Transp trans_rhs1
...
template<class T_Matrix>
void SparseLinAlgPack::V_MtV(DVectorSlice& v_lhs, const T_Matrix& gm_rhs1, BLAS_Cpp::Transp trans_rhs1
	, const DVectorSlice& vs_rhs2)
{
	imp_assert_V_MtV_rhs_sizes(gm_rhs1,trans_rhs1,vs_rhs2);
