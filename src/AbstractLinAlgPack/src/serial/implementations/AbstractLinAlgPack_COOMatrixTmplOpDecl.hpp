...
/** @name {\bf Linear algebra operations for coordinate matrices}.
  *
  ...
  * iterator.  These elements need not be sorted but the operations may
  * perform better if they are.  What order will dependent on which operation
  * and which options.  See the individual operations to determine which sorting
  * orders are best.
  *
