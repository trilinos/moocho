...
//@{
/// v_lhs += op v_rhs
void Vp_V_assert_compatibility(VectorWithOpMutable* v_lhs, const VectorWithOp& v_rhs);
/// v_lhs += op sv_rhs
void Vp_V_assert_compatibility(VectorWithOpMutable* v_lhs, const SpVectorSlice& sv_rhs);
/// v_rhs1 op v_rhs2
void VopV_assert_compatibility(const VectorWithOp& v_rhs1, const VectorWithOp& v_rhs2);
/// v_rhs1 op sv_rhs2
void VopV_assert_compatibility(const VectorWithOp& v_rhs1, const SpVectorSlice& sv_rhs2);
/// sv_rhs1 op v_rhs2
void VopV_assert_compatibility(const SpVectorSlice& sv_rhs1, const VectorWithOp& v_rhs2);
